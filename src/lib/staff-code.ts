...
export const staffCodePrefixes: Record<StaffRole, string> = {
  owner: "OWN",
  manager: "MGR",
  cashier: "CAS",
};

export function staffCodePrefix(role: StaffRole) {
  return staffCodePrefixes[role];
}

export function nextStaffCode(role: StaffRole, existingCodes: string[]) {
